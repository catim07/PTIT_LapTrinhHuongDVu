...
const CompareBar: React.FC = () => {
  ...
  const hint = canCompare ? 'Sẵn sàng so sánh' : 'Chọn ít nhất 2 sản phẩm';
          ...
          <div className="p-3 md:p-4">
            ...
            <div className="mt-2 grid grid-cols-2 gap-2 md:flex md:items-center md:justify-end">
              ...
              <button
                ...
                title={canCompare ? 'So sánh ngay' : 'Cần ít nhất 2 sản phẩm để so sánh'}
              >
                {canCompare ? 'So sánh ngay' : 'Chọn ít nhất 2 sản phẩm'}
              </button>
            </div>
          </div>
        </div>
