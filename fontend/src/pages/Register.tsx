        ...
        <div className="w-full max-w-md flex flex-col items-center">
          ...
          <div className={`grid ${isGoogleConfigured ? 'grid-cols-2' : 'grid-cols-1'} gap-4 mb-8 w-full`}>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 py-3 px-4 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors disabled:opacity-60"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative group">
                  <input
                    className={`w-full h-12 px-4 rounded-xl border ${errors.password ? 'border-red-500' : 'border-slate-200 dark:border-slate-700'} bg-white dark:bg-slate-800 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all`}
                    placeholder="••••••••"
                  ...
                  <button
                    ...
                    className="absolute right-4 top-10.5 -translate-y-1/2 text-slate-400 hover:text-slate-600"
                  >
              ...
              <div>
                ...
                <div className="relative group">
                  <input
                    className={`w-full h-12 px-4 rounded-xl border ${errors.confirmPassword ? 'border-red-500' : 'border-slate-200 dark:border-slate-700'} bg-white dark:bg-slate-800 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all`}
                    placeholder="••••••••"
